...
/*Урок 4. Крестики-нолики в процедурном стиле
        ...
        4. *** Попробовать переписать логику проверки победы, чтобы она работала для поля 5х5 и количества фишек 4.
...
class Lesson_04 {
    // Для решения четвертого пункта необходимо установить   SIZE = 5 (размер поля), и NUMBER_TO_WIN = 4 (количество фишек)
